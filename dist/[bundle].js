...
___CSS_LOADER_EXPORT___.push([module.id, `@font-face {
  ...
  `, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,qBAAqB;IACrB;4DACsC;IACtC,gBAAgB;IAChB,kBAAkB;EACpB;;EAEA;;;;KAIG;;EAEH;IACE,YAAY;EACd","sourcesContent":["@font-face {\n    font-family: 'MyFont';\n    src: url('./my-font.woff2') format('woff2'),\n      url('./my-font.woff') format('woff');\n    font-weight: 600;\n    font-style: normal;\n  }\n\n  /* .hello {\n    color: red;\n   font-family: 'MyFont';\n    background: url('./icon.png');\n  } */\n\n  .Hi {\n    color: green;\n  }\n  "],"sourceRoot":""}]);
// Exports
...
button.addEventListener('click', function () {
    // convertToJson(weather('gothenburg')).then(resolve => console.log(resolve));
